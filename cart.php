...
<html>
    <head>
    <meta charset="utf-8">
    <title>Bun King Bakery | Details</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <!--========== PHP CONNECTION TO DATABASE: Bun King Bakery ==========-->
    <?php 
            ...
            <div class="col-lg">
                ...
                <div class="cart_title_bar mx-1 ">
                    ...
                    <div class="cart-title-4">
                        <h4 class="section-all my-0 py-0 hide-wave">Total Price (CAD)</h4>
                    </div>
                ...
                <div class="receipt-card mt-2 mb-3 mx-1 py-3">
                    ...
                    <div class="">
                        ...
                        <div class="product-name">
                            <div class="product-name-det">
                                ...
                                <h6>CAD <?php echo number_format($product['price'], 2);?> / unit</h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tot-price-per-item ">
                        <h6>CAD <?php echo number_format($product['quantity'] * $product['price'], 2); ?></h6>
                    </div>
            ...
            <div class="col-md container receipt-area mx-auto">
                ...
                <div class="row container receipt-data mx-auto pt-3">
                    ...
                    <div class="row container subtotal-area my-1">
                        ...
                        <div class="col">
                            <h4 class="subtitle">CAD <?php echo number_format($total, 2); ?></h4>
                        </div>
                    </div>
                    <!-- delivery -->
