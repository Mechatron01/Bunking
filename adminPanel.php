        ...
        if(isset($_POST['sendMail'])){
            if(!empty($_POST['message'])) {
                ...
                if(mysqli_num_rows($result) > 0)
                {
                    ...
                    $to = "Bun King Bakery.cakeshop@gmail.com";
                    if(isset($_POST['subject']))
                    {
                        $subject = test_input($_POST['subject']);
                    }
                    $msg = $message;
                    $headers = "From: Bun King Bakery.cakeshop@gmail.com \r\n";
...
<html lang="en-MU">
    <head>
        <meta charset="utf-8">
        <title>Bun King Bakery | ADMIN PANEL</title>
    ...
    <body>
        ...
        <div class="container">
            <ul class="nav nav-tabs">
                ...
                <li><a data-toggle="pill" href="#addproduct">Modify Products</a></li>
                <li><a data-toggle="pill" href="#allOrders">All Orders</a></li>
                <li><a data-toggle="pill" href="#futureOrders">Future Orders</a></li>
            </ul>
            ...
            <div class="tab-content">
                ...
                <div id="addproduct" class="tab-pane fade in active">
                    ...
                    <!--Start User Profile-->
                   <?php include './Includes/manageproducts.php'; ?>
                    <!-- End User Profile -->
                </div>
                ...
                <div id="allOrders" class="tab-pane fade in active">
                    ...
                    <!--Start User Profile-->
                   <?php include './Includes/adminAccountOrders.php'; ?>
                    <!-- End User Profile -->
                </div>
                <div id="futureOrders" class="tab-pane fade in active">
                    <div class="tab-title">
                        <h3>Future Orders</h3>
                    </div>
                    
                    <!--Start User Profile-->
                   <?php include './Includes/adminfutureOrders.php'; ?>
                    <!-- End User Profile -->
                </div>
