...
<html lang="en-MU">
    <head>
        <meta charset="utf-8">
        <title>Bun King Bakery | MAKE YOUR CAKE</title>
    ...
    <body>
        ...
        <footer class="footer-group">
            ...
            <div class="footer">
                ...
                <div class="logo">
                    <span class="logo-name">Bun King Bakery</span>
                </div>
                ...
                <div class="contact-links">
                    <span class="phone"><i class="fas fa-phone-square-alt"></i> 647-852-7844</span>
                    <span class="address">240 Harwood Avenue South, Ajax, ON L1S 2H6</span>
                </div>
                ...
                <div class="copyright">
                    <span class="copyright-text">&#169; Design by Team Mechatrons</span>
                </div>
